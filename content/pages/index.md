...
sections:
  ...
  - type: FeaturedItemsSection
    ...
    items:
      ...
      - type: FeaturedItem
        ...
        text: "\\<div style=\"text-align: center\">Segundo pesquisas, os resíduos\_recicláveis\_secos são compostos principalmente pelos\_plásticos\_(16,8%, com 13,8 milhões de toneladas por ano),\_papel\_e\_papelão\_(10,4%, ou 8,57 milhões de toneladas anuais), vidros (2,7%), metais (2,3%) e embalagens multicamadas (1,4%).\\</div>\n\n"
        image:
          type: ImageBlock
  ...
  - type: GenericSection
    ...
    media:
      title: Title of the video
      url: 'https://www.youtube.com/watch?v=vxv7x2LcnI8'
      autoplay: true
      loop: true
      muted: true
      controls: false
